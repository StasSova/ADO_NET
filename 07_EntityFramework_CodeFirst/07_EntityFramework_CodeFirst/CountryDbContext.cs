...
namespace _07_EntityFramework_CodeFirst
{
    ...
    {
        //private static CountryDbContext instance;
        //public static CountryDbContext Instance
        //{
        //    get { return instance ?? new CountryDbContext(); }
        //    set { instance = value; }
        //}

        public static string DatabaseName = "EntityFrameWorkCore_CountryDB"; 
        public static string ServerName = "DESKTOP-DSCJOEB\\MSSQLSERVERDEV";
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseLazyLoadingProxies().UseSqlServer($@"Server={ServerName};Database={DatabaseName};Integrated Security=SSPI;TrustServerCertificate=true");
        }
    }
}
